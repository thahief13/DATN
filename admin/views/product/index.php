...
?>
            ...
            <form class="modal-content" method="POST" action="product/process_create.php" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Chọn một hoặc nhiều cửa hàng</small>
                    </div>
                    <div class="mb-3">
            ...
            modalElement.addEventListener('show.bs.modal', function(event) {
                ...
                if (button) {
                    ...
                    if (modalElement.id === 'editModal') {
                        ...
                        // Initialize store selection - fetch from PHP via AJAX or hardcode
                        // For now, leave empty to be set in process
                        document.getElementById('edit-store-ids').value = '';
                    }
                }
            });
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        searchBtn.addEventListener('click', function() {
            ...
            // Filter productsData by multiple fields
            ...
            console.log('Tìm kiếm:', keyword, 'Kết quả:', filteredProducts.length);
        ...
        function displaySearchResults(filteredProducts) {
            ...
            filteredProducts.forEach(product => {
                ...
                row.innerHTML = `
                    ...
                    <td><img src="/oss_trung_nguyen_coffee/app/img/SanPham/${escapeHtml(product.Img)}" alt="${escapeHtml(product.Title)}" style="width: 100px; height: 60px; object-fit: contain;"></td>
